...
class iContactFormsSettings{

    private $plugin_path;
    private $plugin_url;
    private $l10n;
    private $pluginTemplate;
    private $namespace = '_icontact_forms_';
    private $settingName = 'iContact Forms';
    ...
    function settings_page()
	{
		...
		<div class="wrap">
			...
			<h3>How to use iContact Forms</h3>
			<p>Create a form by clicking on iContact Forms>Add New on the main admin menu.
			<p>Put a GetResponse form in your post or page by placing the shortcode tag <code>[icontact_forms id="%postid%"]</code> on your page or post</p>	
			<p><a href="http://www.thinklandingpages.com/icontact-forms/">iContact Forms Quick Start Guide</a></p>			
